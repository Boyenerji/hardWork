...

{
    ...
    desc: 
    `
    До 1961 года город Волгоград назывался город Сталинград, в честь Иосифа Сталина, который играл важную роль в Сталинградской битве во время Второй мировой войны. 
...

{
    ...
    desc: 
    `
    Голубые киты - самые крупные животные на планете, известные человечеству. Длина взрослого голубого кита может достигать более 30 метров, а вес - свыше 170 тонн. У них огромное сердце, весом около 600 кг, и язык, который может весить столько же, сколько слон. 
    Кроме того, голубые киты издают звуки, которые могут быть услышаны на расстоянии более 160 км, что делает их одними из самых громких животных на Земле.
    `,
    dateWord: ''
},
...

{
    ...
    desc: 
    `
    БМПТ Терминатор - это российский боевой танк, который был разработан на базе танка Т-72.
    БМПТ Терминатор имеет четыре пулемета КПВТ калибра 7,62мм и два автомата ГШ-30-1 калибра 30 мм. Кроме того, на танке могут быть установлены ракетные комплексы "Атака" и "Игла".
    `,
    dateWord: ''
},
...

{
    ...
    desc: 
    `
        ГШ-30-1 - это авиационная пушка, разработанная в Советском Союзе в 1970-х годах. Пушка имеет калибр 30мм и используется на самолетах и вертолетах.
...

{
    ...
    Хрущев провел ряд реформ, направленных на уменьшение репрессий и десталинизацию общества, а также начал процесс развития сельского хозяйства и ликвидации культа личности вокруг Сталина.
