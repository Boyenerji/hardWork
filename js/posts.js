...

{
    ...
    desc: 
    `
        Северная война - война, длившаяся с 1700 по 1721 год между Шведским королевством и коалицией государств Северной Европы за обладание прибалтийскими землями и господством на Балтийском море и его побережье, закончившаяся поражением Швеции, навсегда утратившей статус великой державы.
    .
    `,
...

{
    ...
    desc: 
    `
        Любые наркотики, придуманные человеком, работают по одному и тому же принципу: они конкурируют с теми психоактивными веществами, которые головной мозг все время вырабатывает совершенно самостоятельно.
