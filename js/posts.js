...

{
    ...
    БМПТ Терминатор имеет четыре пулемета КПВТ калибра 7,62мм и две пушки ГШ-30-1 калибра 30мм. Кроме того, на танке могут быть установлены ракетные комплексы "Атака" и "Игла".
    `,
    dateWord: ''
},
