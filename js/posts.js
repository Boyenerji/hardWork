...

{
    ...
    desc: 
    `
        Ленин страдал от нескольких заболеваний. Одним из самых серьезных заболеваний была артериосклероз, который привел к инсульту в 1922 году. В результате этого инсульта у Ленина возникли проблемы со здоровьем, включая проблемы с речью и движением, которые стали усугубляться со временем. Это привело к тому, что Ленин стал больше времени проводить в постели, и в конечном итоге он скончался от осложнений, связанных с инсультом, в январе 1924 года.
    `,
    dateWord: ''
},
