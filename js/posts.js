...

{
    ...
    desc: 
    `
        РПГ - <span class="blur-sm">реактивная противотанковая граната с тандемной боевой частью, калибра 105мм, одноразовый гранатомет</span>.<br>
