...

{
    ...
    desc: ``,
    dateWord: '',
    nameChoice: 'В каком году родился Ленин?',
    choice: [
        '22 апреля 1870',
        '12 апреля 1872',
        '25 апреля 1878',
...

{
    ...
    desc: ``,
    dateWord: '',
    nameChoice: 'В каком году родился Сталин?',
    choice: [
        '28 декабря 1875',
        '12 декабря 1876',
        '15 декабря 1870',
...

{
    ...
    desc: ``,
    dateWord: '',
    nameChoice: 'Где расположена медиальная темпоральная доля мозга?',
    choice: [
        'В теменной',
        'В затылочной части',
        'В боковой части мозга',
        'В лобной части мозга'
    ],
    trueChoice: 'В боковой части мозга',
    isTest: true
},

{
    ...
    desc: ``,
    dateWord: '',
    nameChoice: 'Какое наведение у ПТРК Фагот?',
    choice: [
        'Полуавтоматическое',
        'ГСН',
        'Лазерное'
