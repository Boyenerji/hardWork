...

{
    ...
    desc: 
    `
        система рельсового интерфейса, кронштейн для присоединения дополнительных оружейных аксессуаров и вспомогательных принадлежностей к ручному стрелковому оружию.
        Различие между Пикаттини в ширине прорезей. Можно установить тактический фонарь или лазерный указатель.
    .
    `,
    dateWord: '',
    isInput: true
