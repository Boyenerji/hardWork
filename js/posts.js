...

{
    ...
    desc: 
    `
        РПГ - реактивная противотанковая граната с тандемной БЧ, калибра 105мм и одноразовый гранатомет.<br>
...

{
    ...
    desc: 
    `
        Противотанковый ракетный комплекс с полуавтоматическим командным наведением по проводам.<br>
