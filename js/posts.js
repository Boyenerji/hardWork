...
},
{
    ...
    desc: `
        <p>ГП-25(Костёр) однозарядный 40-мм подствольный гранатомёт.</p>
        <p>ГП-30(Обувка) 40-мм подствольный гранатомёт, разработанный на основе конструкции ГП-25</p>
    `,
    dateWord: ''
},
{
...
// },
{
    ...
    desc: 
    `
        <p>Пётр 1 правил страной на протяжении 43 лет.</p>
        <p>Пётр 1 впервые завёз в Россию популярные цветы, как тюльпаны.</p>
        <p>Причиной смерти Петра I стала пневмония, развившаяся из обыкновенной простуды.</p>
        <p>Пётр 1 учредил медаль "За пьянство" которую вешал на выпивающих бояр. Весила 7кг и надевалась в полицейском участке.</p>
    `,
    dateWord: ''
}
