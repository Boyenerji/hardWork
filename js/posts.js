...

{
    ...
    desc: 
    `
        РПГ - <span class="blur-sm">реактивная противотанковая граната с тандемной БЧ, калибра 105мм, одноразовый гранатомет</span>.<br>
...

{
    ...
    `
        ...
        Ракету выталкивает <span class="blur-sm">вышибной патрон</span>. Ракета летит по спиральной траектории.<br><br>
